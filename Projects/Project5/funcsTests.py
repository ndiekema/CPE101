...
class TestCases(unittest.TestCase):
   ...
   def test_filter_by_mag_0(self):
    ...
    quakes.append(Earthquake('12km SSW of Idyllwild, CA', 0.97, -116.7551651, 33.6391678, 1488177290))
    quakes.append(Earthquake('5km S of Gilroy, California', 2.19, -121.5801697, 36.9580002, 1488173538))
    quakes.append(Earthquake('3km NW of Jerusalem, MA', 8.90, -116.7551651, 33.6391678, 1385177290))
    quakes.append(Earthquake('2km N of Seattle, WA', 4.56, -136.5801697, 36.9580002, 1488143538))
    test.append(Earthquake('5km S of Gilroy, California', 2.19, -121.5801697, 36.9580002, 1488173538))
    test.append(Earthquake('2km N of Seattle, WA', 4.56, -136.5801697, 36.9580002, 1488143538))
    filtered = filter_by_mag(quakes, 1,5)
    self.assertEqual(test,filtered)
   ...
   def test_filter_by_place_0(self):
    ...
    quakes.append(Earthquake('2km N of Seattle, WA', 4.56, -136.5801697, 36.9580002, 1488143538))
    test.append(Earthquake('2km N of Seattle, WA', 4.56, -136.5801697, 36.9580002, 1488143538))
    filtered = filter_by_place(quakes,"WA")
    self.assertEqual(test,filtered)
